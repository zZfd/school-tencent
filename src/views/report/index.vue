 ...
 * @LastEditors: zfd
 * @LastEditTime: 2020-11-20 09:38:05
 * @Description: 职业技能培训报名表
-->
<template>
  <div class="app-container setting-container">
    <van-cell style="margin:20px 0" title="手机" value="13776050390" is-link to="/change/phone" />
    ...
    <van-cell title="培训专业" name="major" value="茶艺" />

    <van-cell title="培训合格证编号" name="qualifiedId" value="training20201120" />
    ...
    <div class="login-out" @click="$router.push('/order-sub/create')">确认</div>
